...
async def get_buying_list(message):
    number1 = 1
    message01 = f'Название: Product{number1} | Описание: описание {number1} | Цена: {number1 * 100}'
    number1 = 2
    message02 = f'Название: Product{number1} | Описание: описание {number1} | Цена: {number1 * 100}'
    number1 = 3
    message03 = f'Название: Product{number1} | Описание: описание {number1} | Цена: {number1 * 100}'
    number1 = 4
    message04 = f'Название: Product{number1} | Описание: описание {number1} | Цена: {number1 * 100}'
    # Выводим в боте
    with open("images/img01.jpg", "rb") as img1:
        await message.answer_photo(img1, message01)  # Показать Товар1
    with open("images/img02.jpg", "rb") as img2:
        await message.answer_photo(img2, message02)  # Показать Товар2
    with open("images/img03.jpg", "rb") as img3:
        await message.answer_photo(img3, message03)  # Показать Товар3
    with open("images/img04.jpg", "rb") as img4:
        await message.answer_photo(img4, message04)  # Показать Товар4
